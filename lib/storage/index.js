...
Storage.prototype.addRoom = function (user, data, options) {
  ...
  return storage.Room.create({
    ...
    return room.addMember(user, _.merge(options, opts)).then(function () {
      return room;
    });
  })
};
...
Storage.prototype.updateRoom = function (room, data, options) {
  ...
  return room.updateAttributes(updates, options)
};
...
Storage.prototype.declineMembership = function (room, invitee, inviter, reason, options) {
  var storage = this;
 ...
 */
Storage.prototype.findOrCreateChannel = function (channelname, user, options) {
  var storage = this;
  ...
  return storage.Channel.findOrCreate({
    ...
    .spread(function (channel, created) {
      ...
      if (created) {
        ...
        return channel.associateUser(channel, user, [], options).then(function () {
