...
Storage.prototype.getRoom = function (owner, roomname) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        owner.getRooms({
            ...
            logger.debug('found rooms' + ownerRooms);
...
Storage.prototype.getRooms = function (user, type) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        case 'member':
            ...
            break;
        case 'pending':
            affiliation.push(storage.RoomMembers.Affiliation.Pending);
            break;
        default: // all 
            affiliation.push(storage.RoomMembers.Affiliation.Owner);
            affiliation.push(storage.RoomMembers.Affiliation.Member);
...
Storage.prototype.inviteMember = function (room, invitee, inviter, reason) {
    var storage = this;
    return new Promise(function (resolve, reject) {
        ...
        room.addMember(invitee, {
            role: storage.RoomMembers.Role.Participant,
            affiliation: storage.RoomMembers.Affiliation.Pending,
            nickname: ''
        }).success(function () {
            // added member to room
            storage.emit('invite', {
    ...
    return new Promise(function (resolve, reject) {
        ...
        room.getMembers({
            ...
            if (users && users.length > 0) {
                ...
                // update data
                roomUser.RoomMembers.affiliation = storage.RoomMembers.Affiliation.Declined;
