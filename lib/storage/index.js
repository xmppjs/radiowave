...
Storage.prototype.addMember = function (room, user, options) {
    ...
    return room.addMember(user, {
        'RoomMember.role': storage.RoomMember.Role.Participant,
        'RoomMember.affiliation': storage.RoomMember.Affiliation.Member,
        'RoomMember.nickname': '',
        'RoomMember.state' : storage.RoomMember.State.Accepted
    }, options)
...
Storage.prototype.inviteMember = function (data, options) {
    ...
    return room.isMember(data.invitee).then(function(){
        ...
        return room.addMember(data.invitee, {
            ...
            'RoomMember.affiliation': storage.RoomMember.Affiliation.Member,
            'RoomMember.nickname': '',
            'RoomMember.state' : storage.RoomMember.State.Pending
