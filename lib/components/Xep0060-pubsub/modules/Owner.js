...
Owner.prototype.handleCreate = function (stanza) {
  ...
  storage.findUser(fromJid).then(function (user) {
    return self.createNewNode(user, nodename, configuration)
  }).then(function () {
...
Owner.prototype.handleDelete = function (stanza) {
  ...
  storage.findUser(fromJid).then(function (u) {
    ...
    return storage.findChannel(nodename, options)
  }).then(function (n) {
    node = n
    if (!node) {
