...
var Features = {
  ...
  /**
   * @description The service supports sending of the last published item to 
                  new subscribers and to newly available resources.
   * @see XEP-0060
   */
  LAST_PUBLISHED: {
    'name': 'http://jabber.org/protocol/pubsub#last-published',
    'desc': 'The service supports sending of the last published item to new subscribers and to newly available resources.', // jshint ignore:line
    'doc': 'XEP-0060'
  },
