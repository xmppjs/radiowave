...
var ltx = require('ltx'),
  ...
  logger = require('../../../core/Logger')('xmlstrorage');
...
PrivateXMLStorage.prototype.handle = function (stanza) {
  ...
  if (data.children.length === 0 ||  data.children.length > 1) {
    ...
    var error = ltx.parse('<error code=\'406\' type=\'modify\'><bad-format xmlns=\'urn:ietf:params:xml:ns:xmpp-stanzas\'/></error>'); // jshint ignore:line
  ...
  // '<error code=\'403\' type=\'cancel\'><forbidden xmlns=\'urn:ietf:params:xml:ns:xmpp-stanzas\'/></error>'
